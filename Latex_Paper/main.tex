...
\begin{document}
	...
	\begin{abstract}
		...
		MAE $=1.09$\,km/h across all six runs. The wrist-worn
		device shows
	...
	\cite{schweizer2024heart}. Beyond the wrist-versus-upper-arm question
	addressed here, in-ear PPG has been validated as a further alternative
	placement with good agreement against ECG-derived heart rate
	\cite{passler2019inear}, chest-strap sensors remain the most extensively
	validated consumer option for cardiac monitoring despite known motion and
	skin-contact limitations \cite{machado2025chestworn}, and multi-sensor
	fusion approaches that combine several imperfect signal sources have been
	proposed as a way to improve robustness beyond what any single placement
	can achieve \cite{john2026multisensor}. It should be noted that such
	...
	highest (4.2\%, roughly $3\times$ the cross-run mean of 1.5\%), and the
	...
	that plausibly increases internal light scattering and degrades
	...
	metric, defined as the quotient of velocity ($v$) and heart rate (HR):
